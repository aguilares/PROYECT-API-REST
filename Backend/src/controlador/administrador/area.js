...
import { Area } from "../../modelo/administrador/area.js"
import { insertar, editar, eliminar, buscar } from '../../validacion/administrador/area.js'
...
rutas.put("/editar", editar, async (req, res) => {
    ...
    try {
        const resultado = await area.editar(datos)
...
rutas.delete("/borrar", eliminar, async (req, res) => {
    try {
        ...
        const resultado = await area.borrar(id)
